...
For medical applications the MITK [TXD ∗ 08] toolkit 
...
extensions
to the system in section \todo{4}, and projects that have
incorporated \textit{Tuvok} in section \todo{5}. We conclude with a
...
Section \todo{5} for examples). In fact, during the compilation
...
UI (see Section \todo{4.2}) and is also the heart of the scripting
...
details are available in Section~\todo{3.2}.
